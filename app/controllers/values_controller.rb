class ValuesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @value.save
        format.html { redirect_to values_url, notice: 'Value was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @value.update(value_params)
        format.html { redirect_to values_url, notice: 'Value was successfully updated.' }
  ...
  private
    ...
    def value_params
      params.require(:value).permit(:title, :description, :image)
    end
end
