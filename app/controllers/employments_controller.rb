class EmploymentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @employment.save
        format.html { redirect_to employments_url, notice: 'Employment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @employment.update(employment_params)
        format.html { redirect_to employments_url, notice: 'Employment was successfully updated.' }
  ...
  private
    ...
    def employment_params
      params.require(:employment).permit(:title, :not_available)
    end
