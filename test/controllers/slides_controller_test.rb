...
class SlidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post slides_url, params: { slide: { background: @slide.background, subtitle: @slide.subtitle, title: @slide.title, url: @slide.url } }
    end
  ...
  test "should update slide" do
    patch slide_url(@slide), params: { slide: { background: @slide.background, subtitle: @slide.subtitle, title: @slide.title, url: @slide.url } }
