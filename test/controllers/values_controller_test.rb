...
class ValuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create value" do
    assert_difference('Value.count') do
      post values_url, params: { value: { description: @value.description, image: @value.image, title: @value.title } }
    end
  ...
  test "should update value" do
    patch value_url(@value), params: { value: { description: @value.description, image: @value.image, title: @value.title } }
