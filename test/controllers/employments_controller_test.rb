...
class EmploymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post employments_url, params: { employment: { not_available: @employment.not_available, title: @employment.title } }
    end
  ...
  test "should update employment" do
    patch employment_url(@employment), params: { employment: { not_available: @employment.not_available, title: @employment.title } }
