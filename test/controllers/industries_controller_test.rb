...
class IndustriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create industry" do
    assert_difference('Industry.count') do
      post industries_url, params: { industry: { not_available: @industry.not_available, title: @industry.title } }
    end
  ...
  test "should update industry" do
    patch industry_url(@industry), params: { industry: { not_available: @industry.not_available, title: @industry.title } }
